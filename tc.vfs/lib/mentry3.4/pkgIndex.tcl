...
# Regular packages:
#
package ifneeded mentry         3.4 \
	[list source [file join $dir mentry.tcl]]
package ifneeded mentry_tile    3.4 \
...
#
package ifneeded Mentry         3.4 \
	[list package require -exact mentry      3.4]
package ifneeded Mentry_tile    3.4 \
	[list package require -exact mentry_tile 3.4]

#
# Code common to all packages:
#
package ifneeded mentry::common 3.4 \
